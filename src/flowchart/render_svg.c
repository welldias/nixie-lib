...
static void render_rect(nixie_strbuf_t *sb, nixie_rect_t b, const char *fill, const char *stroke, double sw) {
    nixie_strbuf_appendf(sb, "<rect x=\"%g\" y=\"%g\" width=\"%g\" height=\"%g\" rx=\"0\" ry=\"0\" fill=\"%s\" stroke=\"%s\" stroke-width=\"%g\" />", b.x, b.y, b.w, b.h, fill, stroke, sw);
}

static void render_rounded_rect(nixie_strbuf_t *sb, nixie_rect_t b, const char *fill, const char *stroke, double sw) {
    nixie_strbuf_appendf(sb, "<rect x=\"%g\" y=\"%g\" width=\"%g\" height=\"%g\" rx=\"6\" ry=\"6\" fill=\"%s\" stroke=\"%s\" stroke-width=\"%g\" />", b.x, b.y, b.w, b.h, fill, stroke, sw);
}

static void render_stadium(nixie_strbuf_t *sb, nixie_rect_t b, const char *fill, const char *stroke, double sw) {
    double r = b.h / 2.0;
    nixie_strbuf_appendf(sb, "<rect x=\"%g\" y=\"%g\" width=\"%g\" height=\"%g\" rx=\"%g\" ry=\"%g\" fill=\"%s\" stroke=\"%s\" stroke-width=\"%g\" />", b.x, b.y, b.w, b.h, r, r, fill, stroke, sw);
}
...
static void render_circle(nixie_strbuf_t *sb, nixie_rect_t b, const char *fill, const char *stroke, double sw) {
    ...
    nixie_strbuf_appendf(sb, "<circle cx=\"%g\" cy=\"%g\" r=\"%g\" fill=\"%s\" stroke=\"%s\" stroke-width=\"%g\" />", cx, cy, r, fill, stroke, sw);
}
...
static void render_diamond(nixie_strbuf_t *sb, nixie_rect_t b, const char *fill, const char *stroke, double sw) {
    ...
    nixie_strbuf_appendf(sb, "<polygon points=\"%g,%g %g,%g %g,%g %g,%g\" fill=\"%s\" stroke=\"%s\" stroke-width=\"%g\" />", cx, cy - hh, cx + hw, cy, cx, cy + hh, cx - hw, cy, fill, stroke, sw);
}
...
static void render_subroutine(nixie_strbuf_t *sb, nixie_rect_t b, const char *fill, const char *stroke, double sw) {
    ...
    nixie_strbuf_appendf(sb, "<line x1=\"%g\" y1=\"%g\" x2=\"%g\" y2=\"%g\" stroke=\"%s\" stroke-width=\"%g\" />", b.x + inset, b.y, b.x + inset, b.y + b.h, stroke, sw);
    nixie_strbuf_appendf(sb, "<line x1=\"%g\" y1=\"%g\" x2=\"%g\" y2=\"%g\" stroke=\"%s\" stroke-width=\"%g\" />", b.x + b.w - inset, b.y, b.x + b.w - inset, b.y + b.h, stroke, sw);
}
...
static void render_double_circle(nixie_strbuf_t *sb, nixie_rect_t b, const char *fill, const char *stroke, double sw) {
    ...
    nixie_strbuf_appendf(sb, "<circle cx=\"%g\" cy=\"%g\" r=\"%g\" fill=\"%s\" stroke=\"%s\" stroke-width=\"%g\" />", cx, cy, outer_r, fill, stroke, sw);
    nixie_strbuf_appendf(sb, "<circle cx=\"%g\" cy=\"%g\" r=\"%g\" fill=\"%s\" stroke=\"%s\" stroke-width=\"%g\" />", cx, cy, inner_r, fill, stroke, sw);
}
...
static void render_hexagon(nixie_strbuf_t *sb, nixie_rect_t b, const char *fill, const char *stroke, double sw) {
    ...
    nixie_strbuf_appendf(sb, "<polygon points=\"%g,%g %g,%g %g,%g %g,%g %g,%g %g,%g\" fill=\"%s\" stroke=\"%s\" stroke-width=\"%g\" />", b.x + inset, b.y, b.x + b.w - inset, b.y, b.x + b.w, b.y + b.h / 2.0, b.x + b.w - inset, b.y + b.h, b.x + inset, b.y + b.h, b.x, b.y + b.h / 2.0, fill, stroke, sw);
}
...
static void render_cylinder(nixie_strbuf_t *sb, nixie_rect_t b, const char *fill, const char *stroke, double sw) {
    ...
    nixie_strbuf_appendf(sb, "<rect x=\"%g\" y=\"%g\" width=\"%g\" height=\"%g\" fill=\"%s\" stroke=\"none\" />", b.x, body_top, b.w, body_h, fill);
    nixie_strbuf_appendf(sb, "<line x1=\"%g\" y1=\"%g\" x2=\"%g\" y2=\"%g\" stroke=\"%s\" stroke-width=\"%g\" />", b.x, body_top, b.x, body_top + body_h, stroke, sw);
    nixie_strbuf_appendf(sb, "<line x1=\"%g\" y1=\"%g\" x2=\"%g\" y2=\"%g\" stroke=\"%s\" stroke-width=\"%g\" />", b.x + b.w, body_top, b.x + b.w, body_top + body_h, stroke, sw);
    nixie_strbuf_appendf(sb, "<ellipse cx=\"%g\" cy=\"%g\" rx=\"%g\" ry=\"%g\" fill=\"%s\" stroke=\"%s\" stroke-width=\"%g\" />", cx, b.y + b.h - ry, b.w / 2.0, ry, fill, stroke, sw);
    nixie_strbuf_appendf(sb, "<ellipse cx=\"%g\" cy=\"%g\" rx=\"%g\" ry=\"%g\" fill=\"%s\" stroke=\"%s\" stroke-width=\"%g\" />", cx, body_top, b.w / 2.0, ry, fill, stroke, sw);
}

static void render_asymmetric(nixie_strbuf_t *sb, nixie_rect_t b, const char *fill, const char *stroke, double sw) {
    double indent = 12.0;
    nixie_strbuf_appendf(sb, "<polygon points=\"%g,%g %g,%g %g,%g %g,%g %g,%g\" fill=\"%s\" stroke=\"%s\" stroke-width=\"%g\" />", b.x + indent, b.y, b.x + b.w, b.y, b.x + b.w, b.y + b.h, b.x + indent, b.y + b.h, b.x, b.y + b.h / 2.0, fill, stroke, sw);
}
...
static void render_trapezoid(nixie_strbuf_t *sb, nixie_rect_t b, const char *fill, const char *stroke, double sw) {
    ...
    nixie_strbuf_appendf(sb, "<polygon points=\"%g,%g %g,%g %g,%g %g,%g\" fill=\"%s\" stroke=\"%s\" stroke-width=\"%g\" />", b.x + inset, b.y, b.x + b.w - inset, b.y, b.x + b.w, b.y + b.h, b.x, b.y + b.h, fill, stroke, sw);
}

static void render_trapezoid_alt(nixie_strbuf_t *sb, nixie_rect_t b, const char *fill, const char *stroke, double sw) {
    double inset = b.w * 0.15;
    nixie_strbuf_appendf(sb, "<polygon points=\"%g,%g %g,%g %g,%g %g,%g\" fill=\"%s\" stroke=\"%s\" stroke-width=\"%g\" />", b.x, b.y, b.x + b.w, b.y, b.x + b.w - inset, b.y + b.h, b.x + inset, b.y + b.h, fill, stroke, sw);
}
...
static void render_state_end(nixie_strbuf_t *sb, nixie_rect_t b, const char *text_color) {
    ...
    nixie_strbuf_appendf(sb, "<circle cx=\"%g\" cy=\"%g\" r=\"%g\" fill=\"none\" stroke=\"%s\" stroke-width=\"%g\" />", cx, cy, outer_r, text_color, STROKE_WIDTH_INNER * 2);
...
static void render_node_shape(nixie_strbuf_t *sb, const nixie_pf_node_t *node, const nixie_resolved_colors_t *colors) {
    ...
    switch (node->shape) {
    case NIXIE_SHAPE_DIAMOND:
        render_diamond(sb, box, fill, stroke, STROKE_WIDTH_INNER);
        break;
    case NIXIE_SHAPE_ROUNDED:
        render_rounded_rect(sb, box, fill, stroke, STROKE_WIDTH_INNER);
        break;
    case NIXIE_SHAPE_STADIUM:
        render_stadium(sb, box, fill, stroke, STROKE_WIDTH_INNER);
        break;
    case NIXIE_SHAPE_CIRCLE:
        render_circle(sb, box, fill, stroke, STROKE_WIDTH_INNER);
        break;
    case NIXIE_SHAPE_SUBROUTINE:
        render_subroutine(sb, box, fill, stroke, STROKE_WIDTH_INNER);
        break;
    case NIXIE_SHAPE_DOUBLECIRCLE:
        render_double_circle(sb, box, fill, stroke, STROKE_WIDTH_INNER);
        break;
    case NIXIE_SHAPE_HEXAGON:
        render_hexagon(sb, box, fill, stroke, STROKE_WIDTH_INNER);
        break;
    case NIXIE_SHAPE_CYLINDER:
        render_cylinder(sb, box, fill, stroke, STROKE_WIDTH_INNER);
        break;
    case NIXIE_SHAPE_ASYMMETRIC:
        render_asymmetric(sb, box, fill, stroke, STROKE_WIDTH_INNER);
        break;
    case NIXIE_SHAPE_TRAPEZOID:
        render_trapezoid(sb, box, fill, stroke, STROKE_WIDTH_INNER);
        break;
    case NIXIE_SHAPE_TRAPEZOID_ALT:
        render_trapezoid_alt(sb, box, fill, stroke, STROKE_WIDTH_INNER);
        break;
    case NIXIE_SHAPE_STATE_START:
        render_state_start(sb, box, colors->text);
        break;
    case NIXIE_SHAPE_STATE_END:
        render_state_end(sb, box, colors->text);
        break;
    case NIXIE_SHAPE_RECTANGLE:
    default:
        render_rect(sb, box, fill, stroke, STROKE_WIDTH_INNER);
        break;
    }
}
...
static void render_node(nixie_strbuf_t *sb, const nixie_pf_node_t *node, const nixie_resolved_colors_t *colors) {
    ...
    if ((node->shape != NIXIE_SHAPE_STATE_START && node->shape != NIXIE_SHAPE_STATE_END) && has_label) {
        ...
        char attrs[160];
        snprintf(attrs, sizeof(attrs), "text-anchor=\"middle\" font-size=\"%g\" font-weight=\"%d\" fill=\"%s\"", FONT_SIZE_NODE_LABEL, FONT_WEIGHT_NODE_LABEL, colors->text);
...
static void render_edge_label(nixie_strbuf_t *sb, const nixie_pf_edge_t *edge, const nixie_resolved_colors_t *colors) {
    ...
    nixie_strbuf_appendf(sb, "<rect x=\"%g\" y=\"%g\" width=\"%g\" height=\"%g\" rx=\"2\" ry=\"2\" fill=\"%s\" stroke=\"%s\" stroke-width=\"1\" />\n", mid.x - bg_w / 2.0, mid.y - bg_h / 2.0, bg_w, bg_h, colors->bg, colors->inner_stroke);

    char attrs[160];
    snprintf(attrs, sizeof(attrs), "text-anchor=\"middle\" font-size=\"%g\" font-weight=\"%d\" fill=\"%s\"", FONT_SIZE_EDGE_LABEL, FONT_WEIGHT_EDGE_LABEL, colors->text_sec);
...
char *nixie_flowchart_render_svg(const nixie_positioned_flowchart_t *pf, const nixie_resolved_colors_t *colors, int transparent) {
    ...
    nixie_strbuf_appendf(&sb, "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 %g %g\" width=\"%g\" height=\"%g\"", pf->width, pf->height, pf->width, pf->height);
    if (!transparent) {
    ...
    nixie_strbuf_appendf(&sb,
        ...
        ARROW_HEAD_W, ARROW_HEAD_H, ARROW_HEAD_W - 1, ARROW_HEAD_H / 2.0, ARROW_HEAD_W, ARROW_HEAD_H / 2.0, ARROW_HEAD_H, colors->arrow, colors->arrow);
    nixie_strbuf_appendf(&sb,
        ...
        ARROW_HEAD_W, ARROW_HEAD_H, ARROW_HEAD_H / 2.0, ARROW_HEAD_W, ARROW_HEAD_H / 2.0, ARROW_HEAD_W, ARROW_HEAD_H, colors->arrow, colors->arrow);
    nixie_strbuf_append(&sb, "</defs>\n");
    ...
    for (size_t i = 0; i < pf->edge_count; i++) {
        ...
        if (edge->has_arrow_end)
            nixie_strbuf_append(&sb, " marker-end=\"url(#arrowhead)\"");
        if (edge->has_arrow_start)
            nixie_strbuf_append(&sb, " marker-start=\"url(#arrowhead-start)\"");
        nixie_strbuf_append(&sb, " />\n");
    }
