...
static int is_combining_mark(uint32_t c) {
    return (c >= 0x0300 && c <= 0x036f) || (c >= 0x1ab0 && c <= 0x1aff) || (c >= 0x1dc0 && c <= 0x1dff) || (c >= 0x20d0 && c <= 0x20ff) || (c >= 0xfe20 && c <= 0xfe2f);
}
...
static int is_fullwidth(uint32_t c) {
    return (c >= 0x1100 && c <= 0x115f) || (c >= 0x2e80 && c <= 0x2eff) || (c >= 0x2f00 && c <= 0x2fdf) || (c >= 0x3000 && c <= 0x303f) || (c >= 0x3040 && c <= 0x309f) || (c >= 0x30a0 && c <= 0x30ff) || (c >= 0x3100 && c <= 0x312f) || (c >= 0x3130 && c <= 0x318f) || (c >= 0x3190 && c <= 0x31ff) || (c >= 0x3200 && c <= 0x33ff) || (c >= 0x3400 && c <= 0x4dbf) || (c >= 0x4e00 && c <= 0x9fff) || (c >= 0xac00 && c <= 0xd7af) || (c >= 0xf900 && c <= 0xfaff) || (c >= 0xff00 && c <= 0xff60) || (c >= 0xffe0 && c <= 0xffe6) || (c >= 0x1f300 && c <= 0x1faff) || /* emoji blocks (approximation) */
...
double nixie_char_width(uint32_t c) {
    ...
    if (strchr(very_wide, ch) != NULL)
        return 1.5;
    if (strchr(wide, ch) != NULL)
        return 1.2;
    if (strchr(narrow, ch) != NULL)
        return 0.4;
    if (strchr(semi_narrow_punct, ch) != NULL)
        return 0.5;
    if (ch == 'r')
        return 0.8;
    if (c >= 'A' && c <= 'Z')
